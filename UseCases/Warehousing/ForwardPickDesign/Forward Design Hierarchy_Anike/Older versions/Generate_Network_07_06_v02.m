...
% Travel time from PD to storage node == value of each storage location
...
% % Travel times between storage nodes
% for i=1:length(sd.StorageNetwork.NoteSetList)
%     for j=1:length(sd.StorageNetwork.NoteSetList)
%         time_ij
% 
% 
%     end
