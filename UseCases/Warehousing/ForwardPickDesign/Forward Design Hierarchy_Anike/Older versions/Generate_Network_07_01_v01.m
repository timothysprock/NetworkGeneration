...
% Vertical edges
%VerticalBaySet = NodeSetList(find(NodeSetList(:,2)==),:);
...
gplot(sd.StorageNetwork.EdgeSetAdjList, [UnitedNodeSetList(:,2), UnitedNodeSetList(:,3)], '-*')
hold off
