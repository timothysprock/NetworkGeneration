...
%            end
        ...
        function setTimer(P)
            ...
            set_param(strcat(P.SimEventsPath, '/Process/start_ProcessTimer'), 'TimerTag', strcat('T_', P.Node_Name))
            set_param(strcat(P.SimEventsPath, '/Process/read_ProcessTimer'), 'TimerTag', strcat('T_', P.Node_Name))
        end
